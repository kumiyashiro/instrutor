...
if ((isset($_GET['mil_id'])) && ($_GET['mil_id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbl_militar WHERE mil_id=%s",
                       GetSQLValueString($_GET['mil_id'], "int"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" class="fonte_geral">.:: DELETAR MILITAR ::.</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
