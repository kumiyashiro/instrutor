...
if ((isset($_GET['inst_id'])) && ($_GET['inst_id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbl_instrucao WHERE inst_id=%s",
  ...
  $deleteGoTo = "instrucao_editar.php";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" bgcolor="#CCCCCC" class="fonte_geral">EXCLUIR PUBLICAÇÃO</td>
  </tr>
  <tr>
