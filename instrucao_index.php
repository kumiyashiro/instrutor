...
mysql_select_db($database_conn_instrutor, $conn_instrutor);
$query_rsPesquisa = sprintf("SELECT * FROM tbl_instrucao WHERE inst_titulo LIKE %s AND inst_situacao = 'Aprovado' ORDER BY inst_id DESC", GetSQLValueString("%" . $campo1_rsPesquisa . "%", "text"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" bgcolor="#CCCCCC"><span class="fonte_geral">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="instrucao_index.php">&nbsp;PÁGINA INICIAL</a> | <a href="instrucao_publicar.php">ADICIONAR NOVA PUBLICAÇÃO</a>|<a href="instrucao_editar.php">EDITAR PUBLICAÇÕES</a></span></td>
  </tr>
  <tr>
    <td align="left" bgcolor="#CCCCCC">&nbsp;</td>
  </tr>
  ...
  <tr align="center">
    <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr align="center" bgcolor="#999999">
        ...
        <td width="1187"><span class="fonte_geral">TÍTULO</span></td>
        <td width="132"><span class="fonte_geral">DATA</span></td>
        </tr>
      <?php do { ?>
        <tr bgcolor="#CCCCCC" class="fonte_geral">
          <td align="center" nowrap="nowrap"><a href="instrucao_publicacao.php?inst_id=<?php echo $row_rsPesquisa['inst_id']; ?>" target="_blank"><img src="imagens/11362_256x256.png" width="22" height="22" /></a></td>
