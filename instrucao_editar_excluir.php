    ...
    <td><table width="100%" border="0" cellspacing="2" cellpadding="0">
      ...
      <?php do { ?>
        <tr valign="middle" bgcolor="#CCCCCC" class="fonte_geral">
          <td align="center" nowrap="nowrap">&nbsp;<a href="instrucao_editarpublicacao.php?inst_id=<?php echo $row_rsPesquisa['inst_id']; ?>" target="_blank">EDITAR</a> | <a href="javascript:if(confirm('Deseja excluir esse registro?')) {location = 'instrucao_excluir.php?inst_id=<?php echo $row_rsPesquisa['inst_id']; ?>';}">EXCLUIR</a></td>
