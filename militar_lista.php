...
$query_rsMil = sprintf("SELECT * FROM tbl_militar WHERE mil_nomeguerra LIKE %s AND mil_situacao = 'Ativado' ORDER BY mil_nomeguerra ASC", GetSQLValueString("%" . $campo1_rsMil . "%", "text"));
    ...
    <td align="center"><table width="800" border="0" cellpadding="0" cellspacing="1" class="fonte_geral">
      ...
      <?php do { ?>
        <tr align="center" bgcolor="#CCCCCC">
          ...
          <td nowrap="nowrap">&nbsp;&nbsp;<a href="ficha_militar.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>" target="_blank">VISUALIZAR</a> | <a href="militar_editar.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>" target="_blank">EDITAR</a> | <a href="militar_alterarfoto.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>" target="_blank">ALTERAR FOTO</a>| <a href="javascript:if(confirm('Deseja excluir esse registro?')) {location = 'militar_deletar.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>';}">EXCLUIR</a>&nbsp;</td>
