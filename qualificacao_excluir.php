...
if ((isset($_GET['qual_id'])) && ($_GET['qual_id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbl_qualificar WHERE qual_id=%s",
                       GetSQLValueString($_GET['qual_id'], "int"));

  mysql_select_db($database_conn_instrutor, $conn_instrutor);
  $Result1 = mysql_query($deleteSQL, $conn_instrutor) or die(mysql_error());

  $deleteGoTo = "militar_lista_usuario.php";
...
if (isset($_GET['qual_id'])) {
  $colname_rsQual = $_GET['qual_id'];
}
mysql_select_db($database_conn_instrutor, $conn_instrutor);
$query_rsQual = sprintf("SELECT * FROM tbl_qualificar WHERE qual_id = %s", GetSQLValueString($colname_rsQual, "int"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" class="fonte_geral">.:: EXCLUIR QUALIFICAÇÃO ::.</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
