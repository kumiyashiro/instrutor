...
$query_rsMil = sprintf("SELECT * FROM tbl_militar WHERE mil_nomeguerra LIKE %s AND mil_situacao = 'Desativado' ORDER BY mil_nomeguerra ASC", GetSQLValueString("%" . $campo1_rsMil . "%", "text"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" class="fonte_geral">.:: MILITARES CADASTRADOS DESATIVADOS::.</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
...
<input type="submit" name="button" id="button" value="Pesquisar" />
  ...
  <tr>
    <td align="center" class="fonte_geral"><a href="militar_cadastrar.php">CADASTRAR NOVO MILITAR</a></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
    ...
    <td align="center"><table width="800" border="0" cellpadding="0" cellspacing="1" class="fonte_geral">
      ...
      <?php do { ?>
        <tr align="center" bgcolor="#CCCCCC">
          ...
          <td nowrap="nowrap"><?php echo $row_rsMil['mil_nomeguerra']; ?></td>
          <td nowrap="nowrap"><?php echo $row_rsMil['mil_nomecompleto']; ?></td>
          <td nowrap="nowrap"><?php echo $row_rsMil['mil_pel']; ?></td>
          <td nowrap="nowrap"><?php echo $row_rsMil['mil_funcao']; ?></td>
          <td nowrap="nowrap">&nbsp; <a href="militar_editar.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>">EDITAR</a> | <a href="militar_alterarfoto.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>">ALTERAR FOTO</a>| <a href="javascript:if(confirm('Deseja excluir esse registro?')) {location = 'militar_deletar_desativo.php?mil_id=<?php echo $row_rsMil['mil_id']; ?>';}">EXCLUIR</a>&nbsp;</td>
